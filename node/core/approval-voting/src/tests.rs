...
where
	Compute: Fn() -> HashMap<polkadot_primitives::v3::CoreIndex, criteria::OurAssignment>,
	Check: Fn(ValidatorIndex) -> Result<DelayTranche, criteria::InvalidAssignment>,
{
	fn compute_assignments(
		...
		_leaving_cores: Vec<(
			CandidateHash,
			polkadot_primitives::v3::CoreIndex,
			polkadot_primitives::v3::GroupIndex,
		)>,
	) -> HashMap<polkadot_primitives::v3::CoreIndex, criteria::OurAssignment> {
		self.0()
	}

	fn check_assignment_cert(
		&self,
		_claimed_core_index: polkadot_primitives::v3::CoreIndex,
		validator_index: ValidatorIndex,
		_config: &criteria::Config,
		_relay_vrf_story: polkadot_node_primitives::approval::RelayVRFStory,
		_assignment: &polkadot_node_primitives::approval::AssignmentCert,
		_backing_group: polkadot_primitives::v3::GroupIndex,
...
impl<F>
	MockAssignmentCriteria<
		fn() -> HashMap<polkadot_primitives::v3::CoreIndex, criteria::OurAssignment>,
		F,
	>
{
...
fn test_harness<T: Future<Output = VirtualOverseer>>(
	...
	let _ = keystore.sr25519_generate_new(
		polkadot_primitives::v3::PARACHAIN_KEY_TYPE_ID,

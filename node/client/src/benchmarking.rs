...
use polkadot_primitives::v3::{AccountId, Balance};
...
pub fn benchmark_inherent_data(
	...
	let para_data = polkadot_primitives::v3::InherentData {
		bitfields: Vec::new(),
	...
	inherent_data.put_data(polkadot_primitives::v3::PARACHAINS_INHERENT_IDENTIFIER, &para_data)?;

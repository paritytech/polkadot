...
/// them but now can.
#[tracing::instrument(level = "trace", skip(peers, ctx, active_heads, metrics), target = LOG_TARGET)]
...
#[tracing::instrument(level = "trace", skip(peers, ctx), target = LOG_TARGET)]
...
#[tracing::instrument(level = "trace", skip(peer_data, ctx, active_head, metrics), target = LOG_TARGET)]
...
#[tracing::instrument(level = "trace", skip(peer_data, ctx, active_heads, metrics), target = LOG_TARGET)]
...
#[tracing::instrument(level = "trace", skip(peers, active_heads, ctx, metrics), target = LOG_TARGET)]

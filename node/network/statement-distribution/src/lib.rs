...
/// them but now can.
#[tracing::instrument(level = "trace", skip(peers, ctx, active_heads, metrics), fields(target = LOG_TARGET))]
...
#[tracing::instrument(level = "trace", skip(peers, ctx), fields(target = LOG_TARGET))]
...
#[tracing::instrument(level = "trace", skip(peer_data, ctx, active_head, metrics), fields(target = LOG_TARGET))]
...
#[tracing::instrument(level = "trace", skip(peer_data, ctx, active_heads, metrics), fields(target = LOG_TARGET))]
...
#[tracing::instrument(level = "trace", skip(peers, active_heads, ctx, metrics), fields(target = LOG_TARGET))]

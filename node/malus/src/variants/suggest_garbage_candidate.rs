...
use polkadot_primitives::v3::CandidateDescriptor;
...
use polkadot_primitives::v3::CandidateReceipt;
			...
			FromOrchestra::Communication {
				...
				if generate_malicious_candidate == true {
					...
					let (collator_id, collator_signature) = {
						use polkadot_primitives::v3::CollatorPair;
						use sp_core::crypto::Pair;

						let collator_pair = CollatorPair::generate().0;
						let signature_payload = polkadot_primitives::v3::collator_signature_payload(
							&relay_parent,

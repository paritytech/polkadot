...
use sc_client_api::{LockImportRun, ProofProvider, ProvideUncles, StorageProvider, ExecutorProvider, Finalizer, BlockchainEvents, BlockBackend, UsageProvider, AuxStore, TransactionFor};
...
// 			Block = Block,
// 			Runtime= polkadot_runtime::RuntimeApi,
...
// 		impl AbstractService<
// 			Block = Block,
// 			Runtime= kusama_runtime::RuntimeApi,
// 			Backend = TFullBackend<Block>,
// 			SelectChain = LongestChain<TFullBackend<Block>, Block>,
...
// 		impl AbstractService<
// 			Block = Block,
// 			Runtime= westend_runtime::RuntimeApi,
// 			Backend = TFullBackend<Block>,
// 			SelectChain = LongestChain<TFullBackend<Block>, Block>,
// 			CallExecutor = TFullCallExecutor<Block, KusamaExecutor>,
// 		>,
...
pub fn new_light<RuntimeApi, Dispatch, Extrinsic>(
	mut config: Configuration,
)
	-> Result<impl AbstractService<
		Block = Block,

...
pub use polkadot_core_primitives::v2::{
	...
	ChainId, DmqContentsBounds, DownwardMessage, Hash, Header, InboundDownwardMessage,
	InboundHrmpMessage, MessageQueueChain, Moment, Nonce, OutboundHrmpMessage, Remark, Signature,
	UncheckedExtrinsic,
};

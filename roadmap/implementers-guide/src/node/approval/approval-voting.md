...
#### Check Approval
  ...
  * If we have `3 * n_approvals > 2 * n_validators`, return true. This is because any set with f+1 validators must have at least one honest validator, who has approved the candidate.

...
alice: js-script ./0003-deregister-register-validator.js with "deregister,Dave" return is 0 within 1200 secs
dave: reports polkadot_node_is_active_validator is 0 within 240 secs

# register and check
alice: js-script ./0003-deregister-register-validator.js with "register,Dave" return is 0 within 1200 secs
dave: reports polkadot_node_is_active_validator is 1 within 240 secs
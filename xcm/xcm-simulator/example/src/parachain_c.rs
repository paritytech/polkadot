...
impl pallet_xcm::Config for Runtime {
	...
	// The version is set to 2, to test sending an XCM message from a parachain on xcm v3 to one on xcm v2
	type AdvertisedXcmVersion = frame_support::traits::ConstU32<2>;
	type Currency = Balances;

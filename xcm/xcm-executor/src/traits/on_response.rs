...
pub trait OnResponse {
	...
	fn on_response(origin: MultiLocation, query_id: u64, response: Response, max_weight: Weight) -> Weight;
}
impl OnResponse for () {
	fn expecting_response(_origin: &MultiLocation, _query_id: u64) -> bool {
		false
	}
	fn on_response(_origin: MultiLocation, _query_id: u64, _response: Response, _max_weight: Weight) -> Weight {
		0
	}
}

...
impl ShouldExecute for TakeWeightCredit {
	fn should_execute<Call>(
		...
		log::trace!(target: "xcm::barriers", "TakeWeightCredit origin: {:?}, message: {:?}, max_weight: {:?}, weight_credit: {:?}", _origin, _message, max_weight, weight_credit);
...
impl<T: Contains<MultiLocation>> ShouldExecute for AllowTopLevelPaidExecutionFrom<T> {
	fn should_execute<Call>(
		...
		log::trace!(target: "xcm::barriers", "AllowTopLevelPaidExecutionFrom origin: {:?}, message: {:?}, max_weight: {:?}, weight_credit: {:?}", origin, message, max_weight, _weight_credit);
...
impl<T: Contains<MultiLocation>> ShouldExecute for AllowUnpaidExecutionFrom<T> {
	fn should_execute<Call>(
		...
		log::trace!(target: "xcm::barriers", "AllowUnpaidExecutionFrom origin: {:?}, message: {:?}, max_weight: {:?}, weight_credit: {:?}", origin, _message, _max_weight, _weight_credit);
		ensure!(T::contains(origin), ());
		Ok(())
	}
}
...
impl<ResponseHandler: OnResponse> ShouldExecute for AllowKnownQueryResponses<ResponseHandler> {
	fn should_execute<Call>(
		...
		log::trace!(target: "xcm::barriers", "AllowKnownQueryResponses origin: {:?}, message: {:?}, max_weight: {:?}, weight_credit: {:?}", origin, message, _max_weight, _weight_credit);
...
impl<T: Contains<MultiLocation>> ShouldExecute for AllowSubscriptionsFrom<T> {
	fn should_execute<Call>(
		...
		log::trace!(target: "xcm::barriers", "AllowSubscriptionsFrom origin: {:?}, message: {:?}, max_weight: {:?}, weight_credit: {:?}", origin, message, _max_weight, _weight_credit);
		ensure!(T::contains(origin), ());

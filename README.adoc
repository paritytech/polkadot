...
* **Polkadot PoC-2 "Krumme Lanke"** is in the link:https://github.com/expenses/substrate/tree/v0.2[**Substrate**] repo branch `v0.2`.
...
[source, shell]
cargo install --git https://github.com/expenses/substrate.git --branch v0.2 polkadot
...
[source, shell]
cargo install --git https://github.com/expenses/substrate.git --tag v0.2.5 polkadot

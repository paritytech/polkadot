...
```
docker build -t staking-miner -f scripts/docker/staking-miner/staking_miner_injected.Dockerfile target/release
```
...
```
docker build -t staking-miner -f scripts/docker/staking-miner/staking_miner_builder.Dockerfile .
```

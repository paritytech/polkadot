...
#[derive(
	PartialEq, Eq, Clone, PartialOrd, Ord, Encode, Decode, Default, RuntimeDebug, derive_more::From, TypeInfo,
)]
#[cfg_attr(any(feature = "runtime-benchmarks", feature = "std"), derive(Serialize, Deserialize, Hash, MallocSizeOf))]

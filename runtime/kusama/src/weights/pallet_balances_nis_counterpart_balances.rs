...
impl<T: frame_system::Config> pallet_balances::WeightInfo for WeightInfo<T> {
	...
	fn set_balance_creating() -> Weight {
		// Minimum execution time: 21_657 nanoseconds.
	...
	fn transfer_all() -> Weight {
		// Minimum execution time: 41_851 nanoseconds.
		Weight::from_ref_time(43_108_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: NisCounterpartBalances Account (r:1 w:1)
	fn force_unreserve() -> Weight {
		// Minimum execution time: 20_008 nanoseconds.
		Weight::from_ref_time(20_670_000)

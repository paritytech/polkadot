...
impl<T: frame_system::Config> pallet_gilt::WeightInfo for WeightInfo<T> {
	...
	fn place_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(35_090_000 as u64)
			// Standard Error: 353
			.saturating_add(Weight::from_ref_time(67_765 as u64).saturating_mul(l as u64))
	...
	fn place_bid_max() -> Weight {
		Weight::from_ref_time(101_793_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt Queues (r:1 w:1)
	...
	fn retract_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(36_905_000 as u64)
			// Standard Error: 365
			.saturating_add(Weight::from_ref_time(53_015 as u64).saturating_mul(l as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	fn pursue_target_noop() -> Weight {
		Weight::from_ref_time(2_663_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:1)
	// Storage: Gilt QueueTotals (r:1 w:1)
	...
	fn pursue_target_per_item(b: u32, ) -> Weight {
		Weight::from_ref_time(39_189_000 as u64)
			// Standard Error: 1_528
			.saturating_add(Weight::from_ref_time(3_905_883 as u64).saturating_mul(b as u64))
	...
	fn pursue_target_per_queue(q: u32, ) -> Weight {
		Weight::from_ref_time(38_455_000 as u64)
			// Standard Error: 3_652
			.saturating_add(Weight::from_ref_time(6_583_391 as u64).saturating_mul(q as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))

...
impl<T: frame_system::Config> pallet_gilt::WeightInfo for WeightInfo<T> {
	...
	fn place_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(35_194_000 as u64)
			// Standard Error: 360
			.saturating_add(Weight::from_ref_time(67_248 as u64).saturating_mul(l as u64))
	...
	fn place_bid_max() -> Weight {
		Weight::from_ref_time(100_033_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt Queues (r:1 w:1)
	...
	fn retract_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(37_145_000 as u64)
			// Standard Error: 364
			.saturating_add(Weight::from_ref_time(55_685 as u64).saturating_mul(l as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	// Storage: Gilt ActiveTotal (r:1 w:1)
	fn thaw() -> Weight {
		Weight::from_ref_time(45_834_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:0)
	fn pursue_target_noop() -> Weight {
		Weight::from_ref_time(2_660_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:1)
	// Storage: Gilt QueueTotals (r:1 w:1)
	...
	fn pursue_target_per_item(b: u32, ) -> Weight {
		Weight::from_ref_time(27_583_000 as u64)
			// Standard Error: 1_260
			.saturating_add(Weight::from_ref_time(3_830_208 as u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	...
	fn pursue_target_per_queue(q: u32, ) -> Weight {
		Weight::from_ref_time(27_934_000 as u64)
			// Standard Error: 2_612
			.saturating_add(Weight::from_ref_time(6_322_688 as u64).saturating_mul(q as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))

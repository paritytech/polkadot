...
impl<T: frame_system::Config> pallet_gilt::WeightInfo for WeightInfo<T> {
	...
	fn place_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(35_781_000 as u64)
			// Standard Error: 369
			.saturating_add(Weight::from_ref_time(78_285 as u64).saturating_mul(l as u64))
	...
	fn place_bid_max() -> Weight {
		Weight::from_ref_time(104_762_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt Queues (r:1 w:1)
	...
	fn retract_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(39_176_000 as u64)
			// Standard Error: 394
			.saturating_add(Weight::from_ref_time(55_669 as u64).saturating_mul(l as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	// Storage: Gilt ActiveTotal (r:1 w:1)
	fn thaw() -> Weight {
		Weight::from_ref_time(46_775_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	fn pursue_target_per_item(b: u32, ) -> Weight {
		Weight::from_ref_time(40_362_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(4_006_772 as u64).saturating_mul(b as u64))
	...
	fn pursue_target_per_queue(q: u32, ) -> Weight {
		Weight::from_ref_time(39_787_000 as u64)
			// Standard Error: 3_747
			.saturating_add(Weight::from_ref_time(6_688_831 as u64).saturating_mul(q as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))

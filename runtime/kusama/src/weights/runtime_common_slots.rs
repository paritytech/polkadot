...
impl<T: frame_system::Config> runtime_common::slots::WeightInfo for WeightInfo<T> {
	...
	fn manage_lease_period_start(c: u32, t: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(6_882_000 as u64).saturating_mul(c as u64))
			// Standard Error: 30_000
			.saturating_add(Weight::from_ref_time(17_866_000 as u64).saturating_mul(t as u64))
	...
	fn trigger_onboard() -> Weight {
		Weight::from_ref_time(21_081_000 as u64)

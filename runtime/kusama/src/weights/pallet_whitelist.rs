...
impl<T: frame_system::Config> pallet_whitelist::WeightInfo for WeightInfo<T> {
	...
	fn whitelist_call() -> Weight {
		...
		Weight::from_ref_time(24_841_000)
	...
	fn remove_whitelisted_call() -> Weight {
		// Minimum execution time: 22_047 nanoseconds.
	...
	fn dispatch_whitelisted_call(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(32_719_000)
			// Standard Error: 11
			.saturating_add(Weight::from_ref_time(1_595).saturating_mul(n.into()))
	...
	fn dispatch_whitelisted_call_with_preimage(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(26_241_721)
			// Standard Error: 6
			.saturating_add(Weight::from_ref_time(1_841).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}

...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		// Minimum execution time: 10_737 nanoseconds.
		Weight::from_ref_time(5_199_422)
			// Standard Error: 13
			.saturating_add(Weight::from_ref_time(1_928).saturating_mul(s.into()))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		// Minimum execution time: 9_815 nanoseconds.
		Weight::from_ref_time(10_064_000)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	// Storage: Ump Overweight (r:1 w:1)
	fn service_overweight() -> Weight {
		// Minimum execution time: 26_215 nanoseconds.
		Weight::from_ref_time(26_895_000)

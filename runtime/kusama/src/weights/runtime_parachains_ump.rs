...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		// Minimum execution time: 11_027 nanoseconds.
		Weight::from_ref_time(2_391_575)
			// Standard Error: 16
			.saturating_add(Weight::from_ref_time(2_351).saturating_mul(s.into()))
	}
	...
	fn service_overweight() -> Weight {
		// Minimum execution time: 29_229 nanoseconds.

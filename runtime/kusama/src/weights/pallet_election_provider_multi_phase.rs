...
impl<T: frame_system::Config> pallet_election_provider_multi_phase::WeightInfo for WeightInfo<T> {
	...
	fn finalize_signed_phase_accept_solution() -> Weight {
		Weight::from_ref_time(28_766_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	...
	fn create_snapshot_internal(v: u32, _t: u32, ) -> Weight {
		Weight::from_ref_time(633_183_000 as u64)
			// Standard Error: 6_648
			.saturating_add(Weight::from_ref_time(396_437 as u64).saturating_mul(v as u64))
	...
	fn elect_queued(a: u32, _d: u32, ) -> Weight {
		Weight::from_ref_time(389_938_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(568_644 as u64).saturating_mul(a as u64))
	...
	fn submit() -> Weight {
		Weight::from_ref_time(51_580_000 as u64)
	...
	fn submit_unsigned(_v: u32, _t: u32, a: u32, _d: u32, ) -> Weight {
		Weight::from_ref_time(6_923_558_000 as u64)
			// Standard Error: 59_946
			.saturating_add(Weight::from_ref_time(7_023_534 as u64).saturating_mul(a as u64))
			.saturating_add(T::DbWeight::get().reads(7 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: ElectionProviderMultiPhase Round (r:1 w:0)
	...
	fn feasibility_check(v: u32, _t: u32, a: u32, _d: u32, ) -> Weight {
		Weight::from_ref_time(6_146_628_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(401_117 as u64).saturating_mul(v as u64))
			// Standard Error: 59_370
			.saturating_add(Weight::from_ref_time(4_713_541 as u64).saturating_mul(a as u64))

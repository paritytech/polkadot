...
impl<T: frame_system::Config> frame_election_provider_support::WeightInfo for WeightInfo<T> {
	...
	fn phragmen(v: u32, _t: u32, d: u32, ) -> Weight {
		(0 as RefTimeWeight)
			...
			.saturating_add((22_196_000 as RefTimeWeight).scalar_saturating_mul(v as Weight))
			// Standard Error: 7_520_000
			.saturating_add((3_555_366_000 as RefTimeWeight).scalar_saturating_mul(d as Weight))
	}
	/// The range of component `v` is `[1000, 2000]`.
	/// The range of component `t` is `[500, 1000]`.
	/// The range of component `d` is `[5, 16]`.
	fn phragmms(v: u32, _t: u32, d: u32, ) -> Weight {
		(0 as RefTimeWeight)
			...
			.saturating_add((15_098_000 as RefTimeWeight).scalar_saturating_mul(v as Weight))
			// Standard Error: 6_402_000
			.saturating_add((2_580_118_000 as RefTimeWeight).scalar_saturating_mul(d as Weight))
	}
}

...
impl<T: frame_system::Config> runtime_common::crowdloan::WeightInfo for WeightInfo<T> {
	...
	fn withdraw() -> Weight {
		Weight::from_ref_time(55_496_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	...
	fn refund(k: u32, ) -> Weight {
		Weight::from_ref_time(61_800_000 as u64)
			// Standard Error: 13_060
			.saturating_add(Weight::from_ref_time(17_425_170 as u64).saturating_mul(k as u64))
	...
	// Storage: Crowdloan NewRaise (r:1 w:1)
	fn poke() -> Weight {
		Weight::from_ref_time(25_618_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Auctions AuctionInfo (r:1 w:0)
	...
	fn on_initialize(n: u32, ) -> Weight {
		Weight::from_ref_time(102_628_000 as u64)
			// Standard Error: 37_432
			.saturating_add(Weight::from_ref_time(39_501_847 as u64).saturating_mul(n as u64))

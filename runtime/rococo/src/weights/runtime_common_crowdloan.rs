...
impl<T: frame_system::Config> runtime_common::crowdloan::WeightInfo for WeightInfo<T> {
	...
	fn withdraw() -> Weight {
		(51_178_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn refund(k: u32, ) -> Weight {
		(30_444_000 as Weight)
			// Standard Error: 11_000
			.saturating_add((17_722_000 as Weight).saturating_mul(k as Weight))
	...
	fn on_initialize(n: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((49_092_000 as Weight).saturating_mul(n as Weight))

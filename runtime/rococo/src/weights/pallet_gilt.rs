...
impl<T: frame_system::Config> pallet_gilt::WeightInfo for WeightInfo<T> {
	...
	fn place_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(37_720_000 as u64)
			// Standard Error: 369
			.saturating_add(Weight::from_ref_time(77_142 as u64).saturating_mul(l as u64))
	...
	fn place_bid_max() -> Weight {
		Weight::from_ref_time(106_476_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt Queues (r:1 w:1)
	...
	fn retract_bid(l: u32, ) -> Weight {
		Weight::from_ref_time(39_363_000 as u64)
			// Standard Error: 360
			.saturating_add(Weight::from_ref_time(56_714 as u64).saturating_mul(l as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:1)
	fn set_target() -> Weight {
		Weight::from_ref_time(7_245_000 as u64)
	...
	// Storage: Gilt ActiveTotal (r:1 w:1)
	fn thaw() -> Weight {
		Weight::from_ref_time(48_004_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:0)
	fn pursue_target_noop() -> Weight {
		Weight::from_ref_time(3_413_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	}
	// Storage: Gilt ActiveTotal (r:1 w:1)
	// Storage: Gilt QueueTotals (r:1 w:1)
	...
	fn pursue_target_per_item(b: u32, ) -> Weight {
		Weight::from_ref_time(41_216_000 as u64)
			// Standard Error: 1_410
			.saturating_add(Weight::from_ref_time(4_030_725 as u64).saturating_mul(b as u64))
	...
	fn pursue_target_per_queue(q: u32, ) -> Weight {
		Weight::from_ref_time(40_228_000 as u64)
			// Standard Error: 4_075
			.saturating_add(Weight::from_ref_time(6_759_571 as u64).saturating_mul(q as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))

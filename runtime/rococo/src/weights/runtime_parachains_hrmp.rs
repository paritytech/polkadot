...
impl<T: frame_system::Config> runtime_parachains::hrmp::WeightInfo for WeightInfo<T> {
	...
	fn force_clean_hrmp(i: u32, e: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((8_620_000 as Weight).saturating_mul(i as Weight))
			// Standard Error: 13_000
			.saturating_add((8_771_000 as Weight).saturating_mul(e as Weight))
	...
	fn force_process_hrmp_open(c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((20_641_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))

...
impl<T: frame_system::Config> pallet_bounties::WeightInfo for WeightInfo<T> {
	...
	fn propose_bounty(d: u32, ) -> Weight {
		// Minimum execution time: 30_017 nanoseconds.
		Weight::from_ref_time(32_784_599)
			// Standard Error: 12
			.saturating_add(Weight::from_ref_time(861).saturating_mul(d.into()))
	...
	fn spend_funds(_b: u32, ) -> Weight {
		// Minimum execution time: 0 nanoseconds.
		Weight::from_ref_time(3_427_067)
	}
}

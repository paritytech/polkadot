...
impl<T: frame_system::Config> pallet_bounties::WeightInfo for WeightInfo<T> {
	...
	fn propose_bounty(d: u32, ) -> Weight {
		...
		Weight::from_ref_time(31_673_110)
			// Standard Error: 5
			.saturating_add(Weight::from_ref_time(834).saturating_mul(d.into()))
	...
	fn close_bounty_proposed() -> Weight {
		// Minimum execution time: 47_373 nanoseconds.
		Weight::from_ref_time(48_026_000)
	...
	fn spend_funds(_b: u32, ) -> Weight {
		// Minimum execution time: 0 nanoseconds.
		Weight::from_ref_time(3_372_484)
	}
}

...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		...
		Weight::from_ref_time(8_068_271)
			// Standard Error: 12
			.saturating_add(Weight::from_ref_time(1_983).saturating_mul(s.into()))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		...
		Weight::from_ref_time(10_134_000)
	...
	fn service_overweight() -> Weight {
		...
		Weight::from_ref_time(27_499_000)

...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		// Minimum execution time: 10_654 nanoseconds.
		Weight::from_ref_time(2_768_168)
			// Standard Error: 15
			.saturating_add(Weight::from_ref_time(2_316).saturating_mul(s.into()))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		...
		Weight::from_ref_time(8_976_000)
	...
	fn service_overweight() -> Weight {
		// Minimum execution time: 28_869 nanoseconds.

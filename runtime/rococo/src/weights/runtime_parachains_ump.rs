...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		// Minimum execution time: 9_816 nanoseconds.
		Weight::from_ref_time(4_361_319 as u64)
			// Standard Error: 13
			.saturating_add(Weight::from_ref_time(1_893 as u64).saturating_mul(s as u64))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		// Minimum execution time: 8_725 nanoseconds.
	...
	fn service_overweight() -> Weight {
		// Minimum execution time: 24_444 nanoseconds.
		Weight::from_ref_time(25_044_000 as u64)

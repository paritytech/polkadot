...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		Weight::from_ref_time(10_118_000 as u64)
			// Standard Error: 8
			.saturating_add(Weight::from_ref_time(1_732 as u64).saturating_mul(s as u64))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		Weight::from_ref_time(9_246_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: Ump Overweight (r:1 w:1)
	fn service_overweight() -> Weight {
		Weight::from_ref_time(24_368_000 as u64)

...
impl<T: frame_system::Config> pallet_im_online::WeightInfo for WeightInfo<T> {
	...
	fn validate_unsigned_and_then_heartbeat(k: u32, e: u32, ) -> Weight {
		// Minimum execution time: 99_004 nanoseconds.
		Weight::from_ref_time(78_439_877)
			// Standard Error: 317
			.saturating_add(Weight::from_ref_time(26_717).saturating_mul(k.into()))
			// Standard Error: 3_195
			.saturating_add(Weight::from_ref_time(335_732).saturating_mul(e.into()))

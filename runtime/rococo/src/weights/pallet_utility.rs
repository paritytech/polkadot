...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(11_491_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(3_583_608 as u64).saturating_mul(c as u64))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(11_119_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(3_764_176 as u64).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		Weight::from_ref_time(13_489_000 as u64)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(11_164_000 as u64)
			// Standard Error: 1_386
			.saturating_add(Weight::from_ref_time(3_568_377 as u64).saturating_mul(c as u64))
	}
}

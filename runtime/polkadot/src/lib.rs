...
pub type Migrations = (
	...
	frame_support::traits::CheckAllVersions<AllPalletsWithSystem>,
);
...
runtime_common::impl_runtime_migration_tests!("wss://polkadot-try-runtime-node.parity-chains.parity.io:443".to_string());

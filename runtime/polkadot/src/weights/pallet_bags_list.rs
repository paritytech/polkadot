...
impl<T: frame_system::Config> pallet_bags_list::WeightInfo for WeightInfo<T> {
	...
	fn rebag_non_terminal() -> Weight {
		// Minimum execution time: 64_631 nanoseconds.
		Weight::from_ref_time(66_636_000)
	...
	fn rebag_terminal() -> Weight {
		// Minimum execution time: 64_746 nanoseconds.
		Weight::from_ref_time(66_806_000)
			.saturating_add(T::DbWeight::get().reads(7))
			.saturating_add(T::DbWeight::get().writes(5))
	}
	// Storage: VoterList ListNodes (r:4 w:4)
	...
	fn put_in_front_of() -> Weight {
		// Minimum execution time: 62_963 nanoseconds.
		Weight::from_ref_time(65_649_000)

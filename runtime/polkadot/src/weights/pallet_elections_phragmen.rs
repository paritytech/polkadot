...
impl<T: frame_system::Config> pallet_elections_phragmen::WeightInfo for WeightInfo<T> {
	...
	fn vote_equal(v: u32, ) -> Weight {
		Weight::from_ref_time(24_201_000 as u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(157_000 as u64).saturating_mul(v as u64))
	...
	fn vote_more(v: u32, ) -> Weight {
		Weight::from_ref_time(36_619_000 as u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(161_000 as u64).saturating_mul(v as u64))
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: PhragmenElection Candidates (r:1 w:0)
	...
	fn vote_less(v: u32, ) -> Weight {
		Weight::from_ref_time(36_953_000 as u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(121_000 as u64).saturating_mul(v as u64))
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: PhragmenElection Voting (r:1 w:1)
	...
	fn remove_voter() -> Weight {
		Weight::from_ref_time(32_792_000 as u64)
	...
	fn submit_candidacy(c: u32, ) -> Weight {
		Weight::from_ref_time(26_285_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(98_000 as u64).saturating_mul(c as u64))
	...
	fn renounce_candidacy_candidate(c: u32, ) -> Weight {
		Weight::from_ref_time(23_041_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(64_000 as u64).saturating_mul(c as u64))
	...
	fn clean_defunct_voters(v: u32, _d: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(61_573_000 as u64).saturating_mul(v as u64))
			.saturating_add(T::DbWeight::get().reads(4 as u64))
	...
	fn election_phragmen(c: u32, v: u32, e: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(138_137_000 as u64).saturating_mul(v as u64))
			// Standard Error: 99_000
			.saturating_add(Weight::from_ref_time(7_943_000 as u64).saturating_mul(e as u64))

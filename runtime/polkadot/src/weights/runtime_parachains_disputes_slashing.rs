...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Measured:  `5711 + n * (285 ±0)`
		//  Estimated: `8939 + n * (288 ±0)`
		// Minimum execution time: 113_896_000 picoseconds.
		Weight::from_parts(136_630_262, 0)
			.saturating_add(Weight::from_parts(0, 8939))
			// Standard Error: 2_274
			.saturating_add(Weight::from_parts(288_526, 0).saturating_mul(n.into()))

...
impl<T: frame_system::Config> frame_election_provider_support::WeightInfo for WeightInfo<T> {
	...
	fn phragmen(v: u32, _t: u32, d: u32, ) -> Weight {
		(0 as RefTimeWeight)
			...
			.saturating_add((22_018_000 as RefTimeWeight).scalar_saturating_mul(v as Weight))
			// Standard Error: 8_192_000
			.saturating_add((3_552_773_000 as RefTimeWeight).scalar_saturating_mul(d as Weight))
	}
	/// The range of component `v` is `[1000, 2000]`.
	/// The range of component `t` is `[500, 1000]`.
	/// The range of component `d` is `[5, 16]`.
	fn phragmms(v: u32, _t: u32, d: u32, ) -> Weight {
		(0 as RefTimeWeight)
			...
			.saturating_add((14_903_000 as RefTimeWeight).scalar_saturating_mul(v as Weight))
			// Standard Error: 6_457_000
			.saturating_add((2_556_711_000 as RefTimeWeight).scalar_saturating_mul(d as Weight))
	}
}

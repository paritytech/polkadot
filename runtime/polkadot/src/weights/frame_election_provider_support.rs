...
impl<T: frame_system::Config> frame_election_provider_support::WeightInfo for WeightInfo<T> {
	...
	fn phragmen(v: u32, t: u32, d: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 16_919_000
			.saturating_add((327_211_000 as Weight).saturating_mul(v as Weight))
			// Standard Error: 33_838_000
			.saturating_add((490_392_000 as Weight).saturating_mul(t as Weight))
			// Standard Error: 1_538_125_000
			.saturating_add((1_768_000_000 as Weight).saturating_mul(d as Weight))
	...
	fn phragmms(v: u32, t: u32, _d: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((332_276_000 as Weight).saturating_mul(v as Weight))
			// Standard Error: 27_317_000
			.saturating_add((493_165_000 as Weight).saturating_mul(t as Weight))
			.saturating_add(T::DbWeight::get().reads(206 as Weight))
			.saturating_add(T::DbWeight::get().reads((4 as Weight).saturating_mul(v as Weight)))
			.saturating_add(T::DbWeight::get().reads((5 as Weight).saturating_mul(t as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))

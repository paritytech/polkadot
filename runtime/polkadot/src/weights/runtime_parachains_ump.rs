...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 5_061 nanoseconds.
		Weight::from_ref_time(5_350_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 11
			.saturating_add(Weight::from_ref_time(2_124).saturating_mul(s.into()))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		...
		Weight::from_ref_time(9_116_000)
	...
	fn service_overweight() -> Weight {
		...
		Weight::from_ref_time(21_594_000)

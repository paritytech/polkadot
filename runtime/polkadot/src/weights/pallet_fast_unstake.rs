...
impl<T: frame_system::Config> pallet_fast_unstake::WeightInfo for WeightInfo<T> {
	...
	fn on_idle_unstake() -> Weight {
		Weight::from_ref_time(73_230_000 as u64)
	...
	fn on_idle_check(x: u32, ) -> Weight {
		Weight::from_ref_time(512_780_000 as u64)
			// Standard Error: 11_509
			.saturating_add(Weight::from_ref_time(14_241_792 as u64).saturating_mul(x as u64))
	...
	fn register_fast_unstake() -> Weight {
		Weight::from_ref_time(98_667_000 as u64)
	...
	fn deregister() -> Weight {
		Weight::from_ref_time(42_310_000 as u64)
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: FastUnstake ErasToCheckPerBlock (r:0 w:1)
	fn control() -> Weight {
		Weight::from_ref_time(4_137_000 as u64)

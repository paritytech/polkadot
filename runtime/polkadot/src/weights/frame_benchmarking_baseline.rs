...
impl<T: frame_system::Config> frame_benchmarking::baseline::WeightInfo for WeightInfo<T> {
	...
	fn sr25519_verification(i: u32, ) -> Weight {
		(1_798_000 as Weight)
			...
			.saturating_add((48_098_000 as Weight).saturating_mul(i as Weight))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn storage_read(i: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 3_000
			.saturating_add((2_781_000 as Weight).saturating_mul(i as Weight))
	...
	fn storage_write(i: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 0
			.saturating_add((454_000 as Weight).saturating_mul(i as Weight))

...
impl<T: frame_system::Config> runtime_common::crowdloan::WeightInfo for WeightInfo<T> {
	...
	fn refund(k: u32, ) -> Weight {
		(0 as RefTimeWeight)
			...
			.saturating_add((19_562_000 as RefTimeWeight).scalar_saturating_mul(k as Weight))
	...
	// Storage: System Account (r:1 w:1)
	fn dissolve() -> Weight {
		(31_834_000 as RefTimeWeight)
			.saturating_add(T::DbWeight::get().reads(2 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes(2 as RefTimeWeight))
	}
	// Storage: Crowdloan Funds (r:1 w:1)
	fn edit() -> Weight {
		(20_820_000 as RefTimeWeight)
	...
	fn on_initialize(n: u32, ) -> Weight {
		(0 as RefTimeWeight)
			...
			.saturating_add((49_451_000 as RefTimeWeight).scalar_saturating_mul(n as Weight))

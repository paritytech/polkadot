...
impl<T: frame_system::Config> runtime_common::crowdloan::WeightInfo for WeightInfo<T> {
	...
	fn refund(k: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((38_108_000 as Weight).saturating_mul(k as Weight))
	...
	fn on_initialize(n: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((101_448_000 as Weight).saturating_mul(n as Weight))

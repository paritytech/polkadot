...
impl<T: frame_system::Config> pallet_nomination_pools::WeightInfo for WeightInfo<T> {
	...
	fn nominate(n: u32, ) -> Weight {
		(41_607_000 as Weight)
			...
			.saturating_add((2_085_000 as Weight).saturating_mul(n as Weight))

...
//! The Sococo runtime for v1 parachains.
...
impl_runtime_weights!(sococo_runtime_constants);

// Make the WASM binary available.
#[cfg(feature = "std")]
include!(concat!(env!("OUT_DIR"), "/wasm_binary.rs"));

/// Runtime version (Sococo).
#[sp_version::runtime_version]
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("sococo"),
	impl_name: create_runtime_str!("parity-sococo-v2.0"),
	authoring_version: 0,
	spec_version: 9200,
	impl_version: 0,

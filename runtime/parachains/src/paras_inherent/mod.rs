...
///   2. Split the array
///   3. Prefer local ones over remote disputes
///   4. If weight is exceeded by locals, pick the older ones (lower indices)
///      until the weight limit is reached.
///   5. If weight is exceeded by locals and remotes, pick remotes

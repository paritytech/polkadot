...
impl WeightInfo for TestWeightInfo {
	fn enter_variable_disputes(v: u32) -> Weight {
		...
		Weight::from_computation(80_000 * v as u64 + 80_000)
	}
	fn enter_bitfields() -> Weight {
		// MAX Block Weight should fit 4 backed candidates
		Weight::from_computation(40_000)
	}
	fn enter_backed_candidates_variable(v: u32) -> Weight {
		// MAX Block Weight should fit 4 backed candidates
		Weight::from_computation(40_000 * v as u64 + 40_000)
	}
	fn enter_backed_candidate_code_upgrade() -> Weight {
		Weight::zero()
	}
...
pub fn signed_bitfields_weight<T: Config>(bitfields_len: usize) -> Weight {
	<<T as Config>::WeightInfo as WeightInfo>::enter_bitfields()
		.saturating_mul(Weight::from_computation(bitfields_len as u64))
}

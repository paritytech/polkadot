	...
	T: Config,
{
	...
	pallet_session::Pallet::<T>::on_initialize(frame_system::BlockNumberOf::<T>::one());
	initializer::Pallet::<T>::on_initialize(frame_system::BlockNumberOf::<T>::one());
	// skip sessions until the new validator set is enacted
	while pallet_session::Pallet::<T>::validators().len() < n as usize {
		pallet_session::Pallet::<T>::rotate_session();
	}
	initializer::Pallet::<T>::on_finalize(frame_system::BlockNumberOf::<T>::one());

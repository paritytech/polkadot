...
fn schedule_blank_para(id: ParaId, paratype: ParaType) {
...
fn add_parathread_claim_works() {
	...
	new_test_ext(genesis_config).execute_with(|| {
		schedule_blank_para(thread_id, ParaType::Parathread);
...
fn session_change_prunes_cores_beyond_retries_and_those_from_non_live_parathreads() {
	...
	new_test_ext(genesis_config).execute_with(|| {
		...
		{
			schedule_blank_para(thread_a, ParaType::Parathread);
			schedule_blank_para(thread_b, ParaType::Parathread);
			schedule_blank_para(thread_c, ParaType::Parathread);
		}
...
fn session_change_shuffles_validators() {
	...
	new_test_ext(genesis_config).execute_with(|| {
		...
		schedule_blank_para(chain_a, ParaType::Parachain);
		schedule_blank_para(chain_b, ParaType::Parachain);
...
fn session_change_takes_only_max_per_core() {
	...
	new_test_ext(genesis_config).execute_with(|| {
		...
		schedule_blank_para(chain_a, ParaType::Parachain);
		schedule_blank_para(chain_b, ParaType::Parachain);
		schedule_blank_para(chain_c, ParaType::Parathread);
...
fn schedule_schedules_including_just_freed() {
	...
	new_test_ext(genesis_config).execute_with(|| {
		...
		schedule_blank_para(thread_b, ParaType::Parathread);
		schedule_blank_para(thread_c, ParaType::Parathread);
		schedule_blank_para(thread_d, ParaType::Parathread);
		schedule_blank_para(thread_e, ParaType::Parathread);
...
fn schedule_clears_availability_cores() {
	...
	new_test_ext(genesis_config).execute_with(|| {
		...
		schedule_blank_para(chain_a, ParaType::Parachain);
		schedule_blank_para(chain_b, ParaType::Parachain);
		schedule_blank_para(chain_c, ParaType::Parachain);

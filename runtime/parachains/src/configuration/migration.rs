		...
		new_test_ext(Default::default()).execute_with(|| {
			...
			for (_, v4) in configs_to_check {
				#[rustfmt::skip]
				{
					...
					assert_eq!(v4.hrmp_max_paras_outbound_channels    	   , v5.hrmp_max_paras_outbound_channels);
					...
					assert_eq!(v4.hrmp_max_paras_inbound_channels          , v5.hrmp_max_paras_inbound_channels);
					...
					assert_eq!(v4.paras_availability_period                , v5.paras_availability_period);

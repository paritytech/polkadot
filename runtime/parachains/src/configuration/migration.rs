...
max_downward_queue_count 				 : 0, //FAIL-CI pre.max_downward_queue_count,
max_downward_queue_size					 : 0, //FAIL-CI pre.max_downward_queue_size,
max_downward_message_size				 : 0, //FAIL-CI pre.max_downward_message_size,
max_downward_message_num_per_candidate	 : 0, //FAIL-CI pre.max_downward_message_num_per_candidate,

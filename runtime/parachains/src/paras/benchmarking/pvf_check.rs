...
use primitives::v3::{HeadData, Id as ParaId, ValidationCode, ValidatorId, ValidatorIndex};
	...
	T: Config + shared::Config,
{
	...
	let required_votes = primitives::v3::supermajority_threshold(validators.len());

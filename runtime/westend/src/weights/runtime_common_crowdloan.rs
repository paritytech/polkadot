...
impl<T: frame_system::Config> runtime_common::crowdloan::WeightInfo for WeightInfo<T> {
	...
	fn refund(k: u32, ) -> Weight {
		(42_888_000 as Weight)
			...
			.saturating_add((37_213_000 as Weight).saturating_mul(k as Weight))
	...
	// Storage: System Account (r:1 w:1)
	fn dissolve() -> Weight {
		(57_905_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
	}
	// Storage: Crowdloan Funds (r:1 w:1)
	fn edit() -> Weight {
		(38_473_000 as Weight)
	...
	fn on_initialize(n: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((101_429_000 as Weight).saturating_mul(n as Weight))

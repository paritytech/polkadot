...
impl<T: frame_system::Config> runtime_common::crowdloan::WeightInfo for WeightInfo<T> {
	...
	fn create() -> Weight {
		Weight::from_ref_time(50_839_000 as u64)
	...
	fn contribute() -> Weight {
		Weight::from_ref_time(119_175_000 as u64)
	...
	fn withdraw() -> Weight {
		Weight::from_ref_time(56_331_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	...
	fn refund(k: u32, ) -> Weight {
		Weight::from_ref_time(61_221_000 as u64)
			// Standard Error: 5_814
			.saturating_add(Weight::from_ref_time(17_042_274 as u64).saturating_mul(k as u64))
	...
	// Storage: System Account (r:1 w:1)
	fn dissolve() -> Weight {
		Weight::from_ref_time(35_550_000 as u64)
	...
	// Storage: unknown [0xd861ea1ebf4800d4b89f4ff787ad79ee96d9a708c85b57da7eb8f9ddeda61291] (r:1 w:1)
	fn add_memo() -> Weight {
		Weight::from_ref_time(31_276_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Crowdloan Funds (r:1 w:0)
	// Storage: Crowdloan NewRaise (r:1 w:1)
	fn poke() -> Weight {
		Weight::from_ref_time(25_086_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Auctions AuctionInfo (r:1 w:0)
	...
	fn on_initialize(n: u32, ) -> Weight {
		Weight::from_ref_time(101_511_000 as u64)
			// Standard Error: 31_388
			.saturating_add(Weight::from_ref_time(39_255_062 as u64).saturating_mul(n as u64))

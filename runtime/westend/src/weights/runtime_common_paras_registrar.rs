...
impl<T: frame_system::Config> runtime_common::paras_registrar::WeightInfo for WeightInfo<T> {
	...
	fn reserve() -> Weight {
		Weight::from_ref_time(32_224_000 as u64)
	...
	fn register() -> Weight {
		Weight::from_ref_time(7_401_513_000 as u64)
	...
	fn force_register() -> Weight {
		Weight::from_ref_time(7_366_819_000 as u64)
			.saturating_add(T::DbWeight::get().reads(7 as u64))
			.saturating_add(T::DbWeight::get().writes(7 as u64))
	}
	// Storage: Registrar Paras (r:1 w:1)
	...
	fn swap() -> Weight {
		Weight::from_ref_time(43_562_000 as u64)

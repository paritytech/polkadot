...
impl<T: frame_system::Config> frame_election_provider_support::WeightInfo for WeightInfo<T> {
	...
	fn phragmen(v: u32, t: u32, d: u32, ) -> Weight {
		(4_561_939_000 as Weight)
			// Standard Error: 5_748_000
			.saturating_add((337_684_000 as Weight).saturating_mul(v as Weight))
			// Standard Error: 11_496_000
			.saturating_add((447_287_000 as Weight).saturating_mul(t as Weight))
			// Standard Error: 522_586_000
			.saturating_add((490_879_000 as Weight).saturating_mul(d as Weight))
	...
	fn phragmms(v: u32, t: u32, _d: u32, ) -> Weight {
		(17_095_455_000 as Weight)
			// Standard Error: 2_088_000
			.saturating_add((331_686_000 as Weight).saturating_mul(v as Weight))
			// Standard Error: 4_177_000
			.saturating_add((448_842_000 as Weight).saturating_mul(t as Weight))
			.saturating_add(T::DbWeight::get().reads(206 as Weight))
			.saturating_add(T::DbWeight::get().reads((4 as Weight).saturating_mul(v as Weight)))
			.saturating_add(T::DbWeight::get().reads((5 as Weight).saturating_mul(t as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))

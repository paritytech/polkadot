...
impl<T: frame_system::Config> frame_election_provider_support::WeightInfo for WeightInfo<T> {
	...
	fn phragmen(v: u32, _t: u32, d: u32, ) -> Weight {
		...
		Weight::from_ref_time(5_493_777_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(5_601_334 as u64).saturating_mul(v as u64))
			// Standard Error: 14_059_549
			.saturating_add(Weight::from_ref_time(1_555_417_760 as u64).saturating_mul(d as u64))
	}
	/// The range of component `v` is `[1000, 2000]`.
	/// The range of component `t` is `[500, 1000]`.
	/// The range of component `d` is `[5, 16]`.
	fn phragmms(v: u32, _t: u32, d: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_311_499_000 as u64)
			// Standard Error: 146_807
			.saturating_add(Weight::from_ref_time(5_470_097 as u64).saturating_mul(v as u64))
			// Standard Error: 15_009_027
			.saturating_add(Weight::from_ref_time(1_764_707_366 as u64).saturating_mul(d as u64))
	}
}

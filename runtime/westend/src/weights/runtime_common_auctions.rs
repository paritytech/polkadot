...
//! DATE: 2021-05-09, STEPS: `[5, ]`, REPEAT: 2, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> runtime_common::auctions::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize() -> Weight {
		(96_768_000_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(2248 as Weight))
			.saturating_add(T::DbWeight::get().writes(2243 as Weight))
	}
	fn cancel_auction() -> Weight {
		(21_818_000_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(73 as Weight))
			.saturating_add(T::DbWeight::get().writes(2233 as Weight))
	}
}

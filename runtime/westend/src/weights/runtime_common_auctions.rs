...
impl<T: frame_system::Config> runtime_common::auctions::WeightInfo for WeightInfo<T> {
	...
	fn bid() -> Weight {
		(149_779_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(8 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	fn on_initialize() -> Weight {
		(204_321_497_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(43277 as Weight))
			.saturating_add(T::DbWeight::get().writes(43273 as Weight))
	}
	fn cancel_auction() -> Weight {
		(52_998_546_000 as Weight)

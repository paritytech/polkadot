...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		// Minimum execution time: 10_852 nanoseconds.
		Weight::from_ref_time(2_587_774)
			// Standard Error: 15
			.saturating_add(Weight::from_ref_time(2_323).saturating_mul(s.into()))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		...
		Weight::from_ref_time(9_486_000)

...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		// Minimum execution time: 10_829 nanoseconds.
		Weight::from_ref_time(9_052_045)
			// Standard Error: 7
			.saturating_add(Weight::from_ref_time(1_914).saturating_mul(s.into()))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		...
		Weight::from_ref_time(10_246_000)
	...
	fn service_overweight() -> Weight {
		...
		Weight::from_ref_time(26_758_000)

...
impl<T: frame_system::Config> runtime_parachains::ump::WeightInfo for WeightInfo<T> {
	...
	fn process_upward_message(s: u32, ) -> Weight {
		// Minimum execution time: 11_013 nanoseconds.
		Weight::from_ref_time(2_207_919)
			// Standard Error: 17
			.saturating_add(Weight::from_ref_time(2_438).saturating_mul(s.into()))
	}
	...
	fn clean_ump_after_outgoing() -> Weight {
		...
		Weight::from_ref_time(9_556_000)
	...
	fn service_overweight() -> Weight {
		// Minimum execution time: 30_250 nanoseconds.
		Weight::from_ref_time(31_098_000)
			.saturating_add(T::DbWeight::get().reads(2))

...
/// We assume that an on-initialize consumes 3% of the weight on average, hence a single extrinsic
/// will not be allowed to consume more than `AvailableBlockRatio - 3%`.
pub const AVERAGE_ON_INITIALIZE_WEIGHT: Perbill = Perbill::from_percent(3);
